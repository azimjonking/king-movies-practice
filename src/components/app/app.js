...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      data: [
        { name: "Empire of Osman", viewers: 998, favourite: false, like: false, id: 1 },
  ...
  // onDelete = id => {
  //   this.setState(({ data }) => {
  //     // const index = data.findIndex(c => c.id !== id) // mutable 0
  //     // data.splice(index, 1) // mutable 0

  //     // const newArr = data.filter(c => c.id !== id) // immutable  1

  //     return {
  //       // data, // mutabel  0
  //       // data: newArr, // immutable   1
  //       data: data.filter(c => c.id !== id), // immutable  2
  //     }
  //   })
  // }    // tekshrish
